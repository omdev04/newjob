<form id="editSettings" class="ajax-form" data-language-id="{{ $languageId }}">
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="call_to_action_title" name="call_to_action_title" value="">
    </div>
    <div class="form-group">
        <label>@lang('modules.frontCms.contactText')</label>
        <textarea name="contact_text" id="contact_text" class="form-control" cols="30" rows="6"></textarea>
    </div>
    <div class="form-group">
        <label>@lang('modules.frontCms.headerImage')</label>
        <div class="card">
            <div class="card-body">
                <input type="file" id="header_image" name="header_image" class="dropify" />
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="card">
            <div class="card-body">
                <input type="file" id="header_backround_image" name="header_backround_image" class="dropify" />
            </div>
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="meta_title" name="meta_details[title]" value="">
    </div>
    <div class="form-group">
        <label for="meta_description" class="control-label">@lang('modules.frontCms.metaDescription')</label>
        <textarea name="meta_details[description]" id="meta_description" class="form-control" cols="30" rows="3"></textarea>
    </div>
    <div class="form-group">
        <label for="meta_keywords" class="control-label">@lang('modules.frontCms.metaKeywords')</label>
        <textarea name="meta_details[keywords]" id="meta_keywords" class="form-control" cols="30" rows="3"></textarea>
    </div>
